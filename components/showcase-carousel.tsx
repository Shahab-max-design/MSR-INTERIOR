...
const slides = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1518002903142-1f4ef6851390?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fFZlcnRpY2FsJTIwQmxpbmRzfGVufDB8fDB8fHww"
  }
]
...
export function ShowcaseCarousel() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-background pb-10 md:pb-20 lg:pb-24 pt-10">
      ...
      <FadeIn className="container mx-auto px-4 mb-8 relative z-10 text-center">
      ...
      <FadeIn delay={0.4} className="flex justify-center gap-3 mt-8 md:mt-12">
